...
function hmac(fn, key, data) {
    ...
    const ipad = Buffer.alloc(blocksize); const
...
exports.createHash = function createHash(alg) { return hash(alg); };
exports.createHmac = function createHmac(alg, key) { return hash(alg, key); };
